"""Backtest Strategy Data Models

Core data models for the backtest strategy abstraction layer:
...
class Signal:
    ...
    Strategies return a list of Signals. The executor + SignalConverter
